...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ShipmentHistory.product_model'
        db.delete_column(u'plts_shipmenthistory', 'product_model_id')


    def backwards(self, orm):
        # Adding field 'ShipmentHistory.product_model'
        db.add_column(u'plts_shipmenthistory', 'product_model',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['plts.ProductModel']),
                      keep_default=False)
