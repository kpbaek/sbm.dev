...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PartType.reg_date'
        db.alter_column(u'plts_parttype', 'reg_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'ManufacturingHistory.reg_date'
        db.alter_column(u'plts_manufacturinghistory', 'reg_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Product.reg_date'
        db.alter_column(u'plts_product', 'reg_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):

        # Changing field 'PartType.reg_date'
        db.alter_column(u'plts_parttype', 'reg_date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'ManufacturingHistory.reg_date'
        db.alter_column(u'plts_manufacturinghistory', 'reg_date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Product.reg_date'
        db.alter_column(u'plts_product', 'reg_date', self.gf('django.db.models.fields.DateTimeField')())
