...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ShipmentHistory'
        db.create_table(u'plts_shipmenthistory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['plts.Product'])),
            ('shipment', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ...
        db.send_create_signal(u'plts', ['ShipmentHistory'])


    def backwards(self, orm):
        # Deleting model 'ShipmentHistory'
        db.delete_table(u'plts_shipmenthistory')
