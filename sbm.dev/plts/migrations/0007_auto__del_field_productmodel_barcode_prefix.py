...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProductModel.barcode_prefix'
        db.delete_column(u'plts_productmodel', 'barcode_prefix')


    def backwards(self, orm):
        # Adding field 'ProductModel.barcode_prefix'
        db.add_column(u'plts_productmodel', 'barcode_prefix',
                      self.gf('django.db.models.fields.CharField')(default=201, max_length=20),
                      keep_default=False)
